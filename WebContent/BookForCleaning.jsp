...
<%
		...
		if(days.equals("aDay"))
		{
			...
			String time1 = request.getParameter("acleaninghrs1");
			String time2 = request.getParameter("lcleaninghrs1");
			...
			try
			{
				...
				if(jsize>0)
				{
					...
					if (i > 0) 
					{
					    ...
					    ResultSet rs3;
					    rs3 = st4.executeQuery("select OneDayJobSchedule from cleaning_maids where MID='" +mid+"'");
						if(rs3.next())
						{
							String new_schedule = rs3.getString(1);
							new_schedule+=schedule;
							String query="UPDATE cleaning_maids SET OneDayJobSchedule='"+new_schedule+"' WHERE MID='"+mid+"'";
	...
	else if(days.equals("MoreDays"))
	{
			...
			try
			{
				...
				else
				{
					%>
					<p>4.No maid found for your requirements...</p>
			        <p>Please go back and try aonce again..</p>
			    	<%
				}
				}
				else
